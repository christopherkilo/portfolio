...
import { EVENT_DETAIL_LOADING_LABEL } from "@/components/demos/event-horizon/ui/Skeleton";

export default function EventDetailLoading() {
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="mb-10 flex justify-center">
        <GravityLoader label={EVENT_DETAIL_LOADING_LABEL} />
      </div>
      <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr]">
        <div
          className="eh-card aspect-[16/10] animate-pulse rounded-2xl border bg-surface-elevated"
          aria-hidden
        />
        <div className="space-y-4" aria-busy="true" aria-label={EVENT_DETAIL_LOADING_LABEL}>
          ...
          <div className="eh-card h-48 w-full animate-pulse rounded-2xl border bg-surface-elevated" />
