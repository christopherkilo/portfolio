...
export default function NetCheckPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <section id="connection-test" className="scroll-mt-24">
      ...
      <section id="troubleshooting" className="scroll-mt-24 rounded-3xl border border-white/8 bg-white/[0.03] p-5 sm:p-6">
