      ...
      {open ? (
        ...
        >
          ...
          <motion.div
            ...
            tabIndex={-1}
            className="eh-glass relative z-10 max-h-[calc(100dvh-2rem)] w-full max-w-lg overflow-y-auto rounded-2xl border p-5 shadow-2xl outline-none focus-visible:ring-2 focus-visible:ring-accent"
